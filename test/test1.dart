...
// //
// //        Log.i(TAG, "🔗 Connecting to name → " + name);
// //
// //        ClingSdk.stopScan();
// //        ClingSdk.setUserId(USER_ID);
// //
...
// //
// //        if (device == null) {
// //            Log.e(TAG, "❌ Device not found in map for name: " + name);
// //            return;
// //        }
// //
...
// //                        Log.i(TAG, "✅ Register success. Waiting for device info...");
// //                    }
// //
// //                    @Override
...
// //
// //            Log.i(TAG, "⚡ Forcing fresh connection using clingId → " + clingId);
// //
// //            // 🔥 Important: use FALSE
