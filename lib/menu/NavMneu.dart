...
import 'package:aspire/View/Notifications.dart';
import 'package:aspire/View/login_Screen.dart';
import 'package:aspire/menu/goal_settings.dart';
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: const Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              Text("Cancel", style: TextStyle(fontSize: 17, color: Colors.black, fontWeight: FontWeight.bold)),
                                              SizedBox(width: 5),
...
//         children: [
//           Container(
//             height: kIsWeb ? 75 : MediaQuery.of(context).size.height * 0.12 < 85
//           ? 85
//           : MediaQuery.of(context).size.height * 0.12,
...
//             ),
//             ListTile(
//               leading: widget.profile == null || widget.profile.trim().isEmpty || widget.profile == "None"
//                   ? GestureDetector(
//                 onTap: () {
//                   Get.to(() => Profile());
//                 },
