...
class _NavMenuState extends State<NavMenu> {
  ...
  //   setState(() => _loadingToggles = true);
  //   final toggleService = Provider.of<ToggleService>(context, listen: false);
  //   await toggleService.loadToggleStates();
  //   setState(() => _loadingToggles = false);
  // }
...
//                   ),
//                 // SizedBox(height: 10,),
//                 if (_toggleService.showBloodPressure)
//                   ListTile(
...
//                   ),
//                 // SizedBox(height: 10,),
//                 if (_toggleService.showHeartRate)
//                   ListTile(
