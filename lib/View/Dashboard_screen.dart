...
//       settings.showBloodPressure.value = false;
//       settings.showHeartRate.value = false;
//       settings.showSteps.value = false;
//       settings.showSleep.value = false;
//       settings.showSpo2.value = false;
//       settings.showWeight.value = false;
//
//       // Update based on API response
//       for (final toggle in result.data) {
//         final isOn = toggle.toggleStatus.toUpperCase() == "ON";
