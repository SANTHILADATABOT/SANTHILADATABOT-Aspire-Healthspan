...
class _BloodPressureChartPageState extends State<BloodPressureChartPage>
  ...
  // Future<void> MultiYear_Chart() async {
  //   if (fromYear == null || toYear == null || fromMonth == null || toMonth == null) {
  //     print('fromYear/fromMonth/toYear/toMonth is null. Cannot call API.');
  //     return;
  //   }
  //
  //   setState(() => isLoading = true);
  ...
  //
  //     final String? recentRaw = result['recent_datetime'];
  //     String formattedDate = 'No recent data';
  //     if (recentRaw != null && recentRaw.isNotEmpty) {
  //       formattedDate = formatDateTime(recentRaw);
  //     }
  //
  //     setState(() {
  //       chartData = result['chartData'];
  ...
  Widget buildWeeklyBloodPressureChart({
    ...
    return Container(
      ...
      child: SfCartesianChart(
        ...
        //   final String? seriesName = args.header;
        //
        //   if (seriesName == 'Systolic') {
        //     args.text = 'Systolic: ${chartData[index].systolic} mmHg';
        //   } else if (seriesName == 'Diastolic') {
        //     args.text = 'Diastolic: ${chartData[index].diastolic} mmHg';
        //   } else {
        //     args.text = ''; // Hide tooltip for range area series
        //   }
        // },
        title: ChartTitle(text: title),
        plotAreaBorderWidth: 0.0,
