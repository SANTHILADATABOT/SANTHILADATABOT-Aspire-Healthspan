...
//       try {
//         final String? clingId = await androidChannel.invokeMethod(
//             "getSavedClingId");
//         print("🔥 Android Saved clingId → $clingId");
//
//         if (clingId != null && clingId.isNotEmpty) {
//           _registeredDevice = clingId;
//           // Trigger auto-reconnect in background
//           androidChannel.invokeMethod("autoReconnect", {"clingId": clingId});
...
//
//       try {
//         final String? lastDeviceID = await iosChannel.invokeMethod('getLastActiveDevice');
